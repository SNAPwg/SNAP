...
CollectData = function(ttStep, simTime, burn, FleetN, DataParams, NoTakeZone, SpaceNumAtAgeT,
  ...
  for(fl in 1:FleetN){
    ...
    FDCPUE <- CollectFisheryCPUE((ttStep-burn+1),SpaceCatAgeByFisher,SpaceEffort,fl,collEffortFD,DataParams$Aggregate,wgtAtAge,DataParams$sigHistCatch)
...
CollectFisheryCPUE <- function(tt,SpaceCatAgeByFisher,SpaceEffort,fl,collEffortFD,Aggregate,wgtAtAge, sigHistCatch){
